        ...
        <>
          {isFetching ? (
            ...
            <>
              ...
              <div className="flex overflow-x-scroll overflow-y-hidden custom-scroll rounded-lg pb-1">
                {imageTypeToShow == "Backdrops" ? (
                  images?.data.backdrops.slice(0, 8).map((item) => (
                    <div key={crypto.randomUUID()} className="min-w-[500px]">
                      <img
                  ...
                  <>
                    {images?.data.posters.slice(0, 8).map((item) => (
                      <div key={crypto.randomUUID()} className="min-w-[185px]">
                        <img
